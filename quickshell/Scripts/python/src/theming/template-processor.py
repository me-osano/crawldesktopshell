...
def main() -> int:
    ...
    if args.terminal_output and args.scheme:
        ...
        try:
            # Extract scheme UI colors for derivation (cPrimary, cOnPrimary, cSecondary)
            scheme_colors = {
                "cPrimary": mode_data.get("cPrimary"),
                "cOnPrimary": mode_data.get("cOnPrimary"),
                "cSecondary": mode_data.get("cSecondary"),
            }
