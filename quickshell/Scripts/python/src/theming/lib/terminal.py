...
class TerminalColors:
    ...
    def from_dict(cls, data: dict, scheme: dict) -> "TerminalColors":
        ...
        Args:
            ...
            scheme: Scheme UI colors (cPrimary, cOnPrimary, cSecondary)
        """
        # Base colors
        ...
        m_primary = scheme.get("cPrimary", cursor)
        m_on_primary = scheme.get("cOnPrimary", cursor_text)
        m_secondary = scheme.get("cSecondary", normal["yellow"])
        m_surface_variant = scheme.get("cSurfaceVariant", selection_bg)
