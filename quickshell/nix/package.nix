...
stdenvNoCC.mkDerivation {
  ...
  installPhase = ''
    mkdir -p $out/share/crawlds-shell $out/bin
    cp -r . $out/share/crawlds-shell
    ln -s ${quickshell}/bin/qs $out/bin/crawlds-shell
  '';
  ...
  preFixup = ''
    qtWrapperArgs+=(
      ...
      --add-flags "-p $out/share/crawlds-shell"
  ...
  meta = {
    ...
    homepage = "https://github.com/me-osano/crawlds-shell";
    license = lib.licenses.mit;
    mainProgram = "crawlds-shell";
  };
}
