...
Singleton {
  ...
  readonly property var _settingsTabMap: ({
                                            ...
                                            "bar": SettingsPanel.Tab.Bar,
                                             "colorscheme": SettingsPanel.Tab.Theme,
                                            ...
                                            "launcher": SettingsPanel.Tab.Launcher,
                                             "location": SettingsPanel.Tab.Geolocation,
                                             "connections": SettingsPanel.Tab.Network,
                                             "bluetooth": SettingsPanel.Tab.Bluetooth,
                                            ...
                                            "systemmonitor": SettingsPanel.Tab.SystemMonitor,
                                             "userinterface": SettingsPanel.Tab.Personalization,
                                             "personalization": SettingsPanel.Tab.Personalization,
                                             "wallpaper": SettingsPanel.Tab.Wallpaper,
                                             "webservice": SettingsPanel.Tab.Webservice
                                           })
