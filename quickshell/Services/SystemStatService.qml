...
Singleton {
  ...
  readonly property color warningColor: Settings.data.systemMonitor.useCustomColors ? (Settings.data.systemMonitor.warningColor || Theme.cTertiary) : Theme.cTertiary
  readonly property color criticalColor: Settings.data.systemMonitor.useCustomColors ? (Settings.data.systemMonitor.criticalColor || Theme.cError) : Theme.cError
  ...
  readonly property color cpuColor: cpuCritical ? criticalColor : (cpuWarning ? warningColor : Theme.cPrimary)
  readonly property color tempColor: tempCritical ? criticalColor : (tempWarning ? warningColor : Theme.cPrimary)
  readonly property color gpuColor: gpuCritical ? criticalColor : (gpuWarning ? warningColor : Theme.cPrimary)
  readonly property color memColor: memCritical ? criticalColor : (memWarning ? warningColor : Theme.cPrimary)
  readonly property color swapColor: swapCritical ? criticalColor : (swapWarning ? warningColor : Theme.cPrimary)

  function getDiskColor(diskPath, available = false) {
    return isDiskCritical(diskPath, available) ? criticalColor : (isDiskWarning(diskPath, available) ? warningColor : Theme.cPrimary);
  }
