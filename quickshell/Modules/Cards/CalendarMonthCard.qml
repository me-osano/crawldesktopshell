    ...
    RowLayout {
      ...
      function getEventColor(event, isToday) {
        if (isMultiDayEvent(event)) {
          return isToday ? Theme.cOnSecondary : Theme.cTertiary;
        } else if (root.isAllDayEvent(event)) {
          return isToday ? Theme.cOnSecondary : Theme.cSecondary;
        } else {
          return isToday ? Theme.cOnSecondary : Theme.cPrimary;
        }
      }
        ...
        Repeater {
          ...
          Item {
            ...
            Rectangle {
              ...
              color: modelData.today ? Theme.cSecondary : "transparent"
