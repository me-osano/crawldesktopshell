...
PopupWindow {
  ...
  CrawlText {
    ...
    family: "Sans Serif" // Match your CrawlText font if different
  ...
  Rectangle {
      ...
      Column {
        ...
        Repeater {
          ...
          Rectangle {
            ...
            color: (!isSeparator && root.hoveredItem === index) ? Theme.cHover : "transparent"
            ...
            Row {
              ...
              CrawlIcon {
                ...
                color: root.hoveredItem === index ? Theme.cOnHover : Theme.cOnSurfaceVariant
                visible: icon !== ""
                anchors.verticalCenter: parent.verticalCenter
              }
    ...
    Rectangle {
      ...
      color: Qt.alpha(Theme.cOutline, 0.7)
      radius: Style.radiusXS
    }
    ...
    Column {
      ...
      Repeater {
        ...
        Rectangle {
          ...
          height: root.rowHeightForItem(modelData)
          color: root.hoveredItem === globalIndex ? Theme.cHover : "transparent"
          radius: Style.radiusXS
          ...
          Row {
            ...
            CrawlIcon {
              icon: modelData.icon
              pointSize: Style.fontSizeL
              color: root.hoveredItem === fixedItemRect.globalIndex ? Theme.cOnHover : Theme.cOnSurfaceVariant
              visible: icon !== ""
              anchors.verticalCenter: parent.verticalCenter
            }
