...
Item {
  ...
  Rectangle {
    ...
    color: Qt.alpha(Theme.cSurface, (isStaticMode ? 0 : Settings.data.dock.backgroundOpacity))
    ...
    border.color: Qt.alpha(Theme.cOutline, (isStaticMode ? 0 : Settings.data.dock.backgroundOpacity))
          ...
          Item {
            ...
            Item {
              ...
              CrawlIcon {
                ...
                color: Theme.resolveColorKey(launcherButton.launcherIconColorKey)
              }
            }
          ...
          delegate: Item {
            ...
            Item {
              ...
              CrawlIcon {
                ...
                icon: "question-mark"
                pointSize: dockRoot.iconSize * 0.7
                color: appButton.isActive ? Theme.cPrimary : Theme.cOnSurfaceVariant
            ...
            Component {
              ...
              Rectangle {
                ...
                border.color: Qt.alpha(Theme.cOutline, 0.7)
                border.width: Style.borderS
                ...
                CrawlText {
                  ...
                  color: appButton.focusedWindowIndex >= 0 ? Theme.cPrimary : Theme.cOnSurfaceVariant
                }
              }
            }
              ...
              Item {
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    color: isFocusedDot ? Theme.cPrimary : Qt.alpha(Theme.cOutline, 0.9)
