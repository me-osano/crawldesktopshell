          ...
          delegate: Item {
            ...
            Item {
              ...
              Rectangle {
                ...
                border.color: Qt.alpha(Theme.cOutline, Settings.data.notifications.backgroundOpacity || 1.0)
                border.width: Style.borderS
                color: Qt.alpha(Theme.cSurface, Settings.data.notifications.backgroundOpacity || 1.0)
                ...
                Rectangle {
                  ...
                  Rectangle {
                    ...
                    color: {
                      var baseColor = model.urgency === 2 ? Theme.cError : model.urgency === 0 ? Theme.cOnSurface : Theme.cPrimary;
                  ...
                  ColumnLayout {
                    ...
                    RowLayout {
                      ...
                      Rectangle {
                        ...
                        color: model.urgency === 2 ? Theme.cError : model.urgency === 0 ? Theme.cOnSurface : Theme.cPrimary
                      }
                    ...
                    Flow {
                      ...
                      Repeater {
                        ...
                        delegate: CrawlButton {
                          ...
                          textColor: hovered ? Theme.cOnHover : Theme.cOnPrimary
