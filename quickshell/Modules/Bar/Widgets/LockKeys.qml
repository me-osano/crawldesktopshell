  ...
  Rectangle {
    ...
    Item {
      ...
      RowLayout {
        ...
        CrawlIcon {
          color: LockKeysService.capsLockOn ? Theme.cTertiary : Qt.alpha(Theme.cOnSurfaceVariant, 0.3)
          icon: root.capsIcon
          visible: root.showCaps && (!root.hideWhenOff || LockKeysService.capsLockOn)
        }

        CrawlIcon {
          color: LockKeysService.numLockOn ? Theme.cTertiary : Qt.alpha(Theme.cOnSurfaceVariant, 0.3)
          icon: root.numIcon
          visible: root.showNum && (!root.hideWhenOff || LockKeysService.numLockOn)
        }

        CrawlIcon {
          color: LockKeysService.scrollLockOn ? Theme.cTertiary : Qt.alpha(Theme.cOnSurfaceVariant, 0.3)
