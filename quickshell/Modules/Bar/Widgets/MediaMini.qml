...
Item {
  ...
  readonly property color textColor: Theme.resolveColorKey(textColorKey)
    ...
    Item {
      ...
      RowLayout {
        ...
        CrawlScrollText {
          ...
          CrawlText {
            color: hasPlayer ? root.textColor : Theme.cOnSurfaceVariant
  ...
  component ProgressRing: Canvas {
    ...
    onPaint: {
      ...
      ctx.strokeStyle = Qt.alpha(Theme.cOnSurface, 0.4);
      ctx.stroke();
      ...
      ctx.lineWidth = lineWidth;
      ctx.strokeStyle = Theme.cPrimary;
      ctx.lineCap = "round";
      ctx.stroke();
    }
  }
