    ...
    GridLayout {
      ...
      Repeater {
        ...
        delegate: Item {
          ...
          readonly property color titleBgColor: (isHovered || isFocused) ? Theme.cHover : Style.capsuleColor
          readonly property color titleFgColor: (isHovered || isFocused) ? Theme.cOnHover : Theme.cOnSurface
              ...
              RowLayout {
                ...
                Item {
                  ...
                  Rectangle {
                    ...
                    height: 4
                    color: taskbarItem.isFocused ? Theme.cPrimary : (taskbarItem.isHovered ? Theme.cHover : "transparent")
