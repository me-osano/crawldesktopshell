...
Item {
  ...
  property color effectColor: Theme.cPrimary
  ...
  function updateWorkspaceFocus() {
    for (var i = 0; i < localWorkspaces.count; i++) {
      ...
      if (ws.isFocused === true) {
        ...
        root.workspaceChanged(ws.id, Theme.cPrimary);
        break;
      }
    }
  }
  ...
  Component {
    ...
    Rectangle {
      ...
      border.color: Settings.data.bar.showOutline ? Style.capsuleBorderColor : Qt.alpha((workspaceModel.isFocused ? Theme.cPrimary : Theme.cOutline), root.groupedBorderOpacity)
      ...
      Flow {
        ...
        Repeater {
          ...
          delegate: Item {
            ...
            property bool itecHovered: false
            ...
            IconImage {
              ...
              layer.effect: ShaderEffect {
                property color targetColor: Settings.data.colorSchemes.darkMode ? Theme.cOnSurface : Theme.cSurfaceVariant
            ...
            MouseArea {
              ...
              onEntered: {
                groupedTaskbarItem.itecHovered = true;
              ...
              onExited: {
                groupedTaskbarItem.itecHovered = false;
                TooltipService.hide();
              }
            }
          }
      ...
      Item {
        ...
        Rectangle {
          ...
          color: {
            if (groupedContainer.workspaceModel.isFocused)
              return Theme.resolveColorKey(root.focusedColor);
            if (groupedContainer.workspaceModel.isUrgent)
              return Theme.cError;
            if (groupedContainer.hasWindows)
              return Theme.resolveColorKey(root.occupiedColor);

            return Theme.resolveColorKey(root.emptyColor);
          }
        ...
        CrawlText {
          ...
          color: {
            if (groupedContainer.workspaceModel.isFocused)
              return Theme.resolveOnColorKey(root.focusedColor);
            if (groupedContainer.workspaceModel.isUrgent)
              return Theme.cOnError;
            if (groupedContainer.hasWindows)
              return Theme.resolveOnColorKey(root.occupiedColor);

            return Theme.resolveOnColorKey(root.emptyColor);
          }
