...
Item {
  ...
  readonly property color iconColor: Theme.resolveColorKey(iconColorKey)
  ...
  Rectangle {
    ...
    Component {
      ...
      Rectangle {
        ...
        property color statColor: Theme.cPrimary // Color based on warning/critical state
        ...
        GridLayout {
          ...
          Loader {
            ...
            onLoaded: {
              ...
              item.statColor = Qt.binding(() => Theme.cPrimary);
            }
          }
        }
      }
