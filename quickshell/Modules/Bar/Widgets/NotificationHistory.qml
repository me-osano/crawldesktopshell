...
CrawlIconButton {
  ...
  readonly property color badgeColor: Theme.resolveColorKey(unreadBadgeColor)
  ...
  Loader {
    ...
    sourceComponent: Rectangle {
      ...
      color: root.hovering ? Theme.cOnHover : (root.badgeColor || Theme.cError)
      border.color: Theme.cSurface
