  ...
  Rectangle {
    ...
    color: {
      ...
      if (workspace.isFocused)
        return Theme.resolveColorKey(focusedColor);
      if (workspace.isUrgent)
        return Theme.cError;
      if (workspace.isOccupied)
        return Theme.resolveColorKey(occupiedColor);
      return Qt.alpha(Theme.resolveColorKey(emptyColor), 0.3);
    }
      ...
      sourceComponent: Component {
        CrawlText {
          ...
          color: {
            ...
            if (workspace.isFocused)
              return Theme.resolveOnColorKey(focusedColor);
            if (workspace.isUrgent)
              return Theme.cOnError;
            if (workspace.isOccupied)
              return Theme.resolveOnColorKey(occupiedColor);
            return Theme.resolveOnColorKey(emptyColor);
          }
