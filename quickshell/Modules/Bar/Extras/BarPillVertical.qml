...
Item {
  ...
  readonly property color bgColor: hovered ? Theme.cHover : (customBackgroundColor.a > 0) ? customBackgroundColor : Style.capsuleColor
  readonly property color fgColor: hovered ? Theme.cOnHover : (customTextIconColor.a > 0) ? customTextIconColor : Theme.cOnSurface
  readonly property color iconFgColor: hovered ? Theme.cOnHover : (customIconColor.a > 0) ? customIconColor : (customTextIconColor.a > 0) ? customTextIconColor : Theme.cOnSurface
  readonly property color textFgColor: hovered ? Theme.cOnHover : (customTextColor.a > 0) ? customTextColor : (customTextIconColor.a > 0) ? customTextIconColor : Theme.cOnSurface
