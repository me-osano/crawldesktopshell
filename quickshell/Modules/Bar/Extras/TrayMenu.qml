  ...
  Flickable {
    ...
    ColumnLayout {
          ...
          Rectangle {
            ...
            RowLayout {
              ...
              Item {
                ...
                // Color Logic
                readonly property color activeColor: mouseArea.containsMouse ? Theme.cOnHover : Theme.cPrimary
                readonly property color checkMarkColor: mouseArea.containsMouse ? Theme.cHover : Theme.cOnPrimary
                readonly property color borderColor: isChecked ? activeColor : (mouseArea.containsMouse ? Theme.cOnHover : Theme.cOnSurface)
              ...
              CrawlText {
                ...
                color: (modelData?.enabled ?? true) ? (mouseArea.containsMouse ? Theme.cOnHover : Theme.cOnSurface) : Theme.cOnSurfaceVariant
              ...
              CrawlIcon {
                ...
                color: (mouseArea.containsMouse ? Theme.cOnTertiary : Theme.cOnSurface)
              }
            }
      ...
      Rectangle {
        ...
        color: pinUnpinMouseArea.containsMouse ? Qt.alpha(Theme.cPrimary, 0.2) : Qt.alpha(Theme.cPrimary, 0.08)
        radius: Style.radiusS
        border.color: Qt.alpha(Theme.cPrimary, pinUnpinMouseArea.containsMouse ? 0.4 : 0.2)
