...
Item {
  ...
  Rectangle {
    ...
    color: DesktopWidgetRegistry.editMode ? Qt.rgba(Theme.cPrimary.r, Theme.cPrimary.g, Theme.cPrimary.b, 0.1) : "transparent"
    border.color: (DesktopWidgetRegistry.editMode || internal.isDragging) ? (internal.isDragging ? Theme.cOutline : Theme.cPrimary) : "transparent"
  ...
  Rectangle {
    ...
    color: Qt.alpha(Theme.cSurface, Settings.data.ui.panelBackgroundOpacity)
    border {
      width: 1
      color: Qt.alpha(Theme.cOutline, 0.12)
    }
    clip: true
  ...
  readonly property color colorHandle: Theme.cSecondary
