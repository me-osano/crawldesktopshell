    ...
    sourceComponent: PanelWindow {
      ...
      Item {
        ...
        Rectangle {
          ...
          color: Qt.rgba(Theme.cSurface.r, Theme.cSurface.g, Theme.cSurface.b, 0.85)
          ...
          ColumnLayout {
            ...
            RowLayout {
              ...
              CrawlIconButton {
                ...
                colorBg: Settings.data.desktopWidgets.gridSnap ? Theme.cPrimary : Theme.cSurfaceVariant
                colorFg: Settings.data.desktopWidgets.gridSnap ? Theme.cOnPrimary : Theme.cPrimary
