...
PopupWindow {
  ...
  // Font scale calculation matching CrawlText behavior
  ...
  // For measuring grid cell widths - must match actual CrawlText font
  TextMetrics {
    id: cellMetrics
  ...
  // For measuring grid row height - hidden CrawlText matches actual grid items exactly
  CrawlText {
    id: rowHeightMeasure
    visible: false
  ...
  // Calculate grid dimensions using measurements that match actual CrawlText rendering
  function calculateGridSize() {
    ...
    // Calculate total height using hidden CrawlText for accurate row height
