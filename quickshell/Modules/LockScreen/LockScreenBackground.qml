...
Item {
  ...
  property color tintColor: Settings.data.colorSchemes.darkMode ? Theme.cSurface : Theme.cOnSurface
  ...
  Rectangle {
    ...
    gradient: Gradient {
      GradientStop {
        position: 0.0
        color: Qt.alpha(Theme.cShadow, 0.8)
      }
      GradientStop {
        position: 0.3
        color: Qt.alpha(Theme.cShadow, 0.4)
      }
      GradientStop {
        position: 0.7
        color: Qt.alpha(Theme.cShadow, 0.5)
      }
      GradientStop {
        position: 1.0
        color: Qt.alpha(Theme.cShadow, 0.9)
      }
    }
  }
  ...
  Item {
    ...
    property color cornerColor: Settings.data.general.forceBlackScreenCorners ? "black" : Theme.cSurface
