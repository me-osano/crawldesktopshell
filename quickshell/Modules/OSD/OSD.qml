    ...
    function getProgressColor() {
      ...
      if (currentOSDType === OSD.Type.LockKey) {
        ...
        if (lastLockKeyChanged.startsWith("CAPS")) {
          return LockKeysService.capsLockOn ? Theme.cPrimary : Theme.cOnSurfaceVariant;
        } else if (lastLockKeyChanged.startsWith("NUM")) {
          return LockKeysService.numLockOn ? Theme.cPrimary : Theme.cOnSurfaceVariant;
        } else if (lastLockKeyChanged.startsWith("SCROLL")) {
          return LockKeysService.scrollLockOn ? Theme.cPrimary : Theme.cOnSurfaceVariant;
        }
      }
    ...
    sourceComponent: PanelWindow {
      ...
      Item {
        ...
        Rectangle {
          ...
          color: Qt.alpha(Theme.cSurface, Settings.data.osd.backgroundOpacity || 1.0)
          border.color: Qt.alpha(Theme.cOutline, Settings.data.osd.backgroundOpacity || 1.0)
          border.width: {
