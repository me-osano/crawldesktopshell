        ...
        ColumnLayout {
          ...
          RowLayout {
            ...
            CrawlIconButton {
              ...
              colorBg: Settings.data.wallpaper.useSolidColor ? Theme.cPrimary : Theme.cSurfaceVariant
              colorFg: Settings.data.wallpaper.useSolidColor ? Theme.cOnPrimary : Theme.cPrimary
          ...
          RowLayout {
            ...
            CrawlIconButton {
              ...
              onClicked: {
                ...
                if (Settings.data.colorSchemes.useWallpaperColors) {
                  ...
                  ThemeService.setPredefinedScheme(Settings.data.colorSchemes.predefinedScheme);
                }
              }
            }
            ...
            CrawlComboBox {
              ...
              model: Settings.data.colorSchemes.useWallpaperColors ? TemplateProcessor.schemeTypes : ThemeService.schemes.map(s => ({
                                                                                                                                            "key": ThemeService.getBasename(s),
                                                                                                                                            "name": ThemeService.getBasename(s)
                                                                                                                                          }))
              ...
              onSelected: key => {
                            ...
                            if (Settings.data.colorSchemes.useWallpaperColors) {
                              ...
                              ThemeService.setPredefinedScheme(key);
                            }
                            Qt.callLater(() => {
                                           _userChanging = false;
                                         });
    ...
    ColumnLayout {
      ...
      RowLayout {
        ...
        CrawlScrollText {
          ...
          Layout.fillWidth: true
          scrollMode: CrawlScrollText.ScrollMode.Hover
          CrawlText {
            text: isBrowseMode ? currentBrowsePath : WallpaperService.getMonitorDirectory(targetScreen?.name ?? "")
          ...
          ColumnLayout {
            ...
            Item {
              ...
              Rectangle {
                ...
                border.color: wallpaperGridView.currentIndex === index ? Theme.cHover : Theme.cSurface
              ...
              Rectangle {
                ...
                color: {
                  if (wallpaperItem.isFavorited)
                    return starHoverHandler.hovered ? Theme.cHover : Theme.cPrimary;
                  return starHoverHandler.hovered ? Theme.cSurfaceVariant : Theme.cSurface;
                }
                ...
                CrawlIcon {
                  ...
                  color: {
                    if (wallpaperItem.isFavorited)
                      return starHoverHandler.hovered ? Theme.cOnHover : Theme.cOnPrimary;
                    return starHoverHandler.hovered ? Theme.cOnSurface : Theme.cOnSurfaceVariant;
                  }
                  anchors.centerIn: parent
                }
            ...
            CrawlText {
              ...
              color: (hoverHandler.hovered || wallpaperItem.isSelected || wallpaperGridView.currentIndex === index) ? Theme.cOnSurface : Theme.cOnSurfaceVariant
          ...
          delegate: Item {
            ...
            ColumnLayout {
              ...
              CrawlText {
                ...
                visible: !Settings.data.wallpaper.hideWallpaperFilenames
                color: (hoverHandler.hovered || wallhavenGridView.currentIndex === index) ? Theme.cOnSurface : Theme.cOnSurfaceVariant
                pointSize: Style.fontSizeXS
                Layout.fillWidth: true
                Layout.leftMargin: Style.marginS
                Layout.rightMargin: Style.marginS
