...
import qs.Modules.Panels.Settings.Tabs.Theme
import qs.Modules.Panels.Settings.Tabs.Network
import qs.Modules.Panels.Settings.Tabs.Bluetooth
...
import qs.Modules.Panels.Settings.Tabs.Webservice
import qs.Services
import qs.Widgets
...
Item {
  ...
  // Set sub-tab on the currently loaded tab content. Returns true if an CrawlTabBar was found.
  ...
  function setSubTabRecursive(item, subTabIndex) {
    ...
    if (item.objectName === "CrawlTabBar") {
      // Prepare the sibling CrawlTabView so the index change doesn't animate
      if (item.parent) {
        for (let j = 0; j < item.parent.children.length; j++) {
          const sibling = item.parent.children[j];
          if (sibling.objectName === "CrawlTabView" && sibling.setIndexWithoutAnimation) {
  ...
  onActiveTabContentChanged: {
    ...
    if (activeTabContent) {
      const tabBar = findCrawlTabBar(activeTabContent);
      if (tabBar) {
  ...
  function findCrawlTabBar(item) {
    ...
    const childCount = item.children ? item.children.length : 0;
    for (let i = 0; i < childCount; i++) {
      const found = findCrawlTabBar(item.children[i]);
      if (found)
        return found;
    }
    return null;
  ...
  function updateTabsModel() {
    let newTabs = [
          ...
          {
            "id": SettingsPanel.Tab.Personalization,
            "label": "Personalization",
            "icon": "settings-user-interface",
            "source": personalizationTab
          },
          {
            "id": SettingsPanel.Tab.Theme,
            "label": "Theme",
          ...
          {
            "id": SettingsPanel.Tab.Bluetooth,
            "label": "Bluetooth",
            "icon": "settings-bluetooth",
            "source": bluetoothTab
          },
          {
            "id": SettingsPanel.Tab.Geolocation,
            "label": "Geolocation",
            "icon": "settings-location",
            "source": geolocationTab
          },
          {
            "id": SettingsPanel.Tab.Webservice,
            "label": "Webservice",
            "icon": "cloud",
            "source": webserviceTab
          },
          {
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      CrawlBox {
        ...
        color: root.sidebarCardStyle ? Theme.cSurfaceVariant : "transparent"
        ...
        ColumnLayout {
          ...
          Item {
            ...
            Rectangle {
              ...
              color: toggleMouseArea.containsMouse ? Theme.cHover : "transparent"
              ...
              RowLayout {
                ...
                CrawlIcon {
                  ...
                  color: toggleMouseArea.containsMouse ? Theme.cOnHover : Theme.cOnSurface
          ...
          Item {
            ...
            Item {
              ...
              Rectangle {
                ...
                anchors.left: parent.left
                radius: Style.radiusS
                color: searchCollapsedMouseArea.containsMouse ? Theme.cHover : "transparent"
                ...
                RowLayout {
                  ...
                  CrawlIcon {
                    icon: "search"
                    color: searchCollapsedMouseArea.containsMouse ? Theme.cOnHover : Theme.cOnSurface
                    pointSize: Style.fontSizeXL
                  }
                }
          ...
          Item {
            ...
            CrawlListView {
              ...
              delegate: Rectangle {
                ...
                color: (effectiveHover || selected) ? Theme.cHover : "transparent"
                ...
                CrawlText {
                  ...
                  color: (resultItem.effectiveHover || resultItem.selected) ? Theme.cOnHover : Theme.cOnSurface
                  Layout.fillWidth: true
                  ...
                  maximumLineCount: 1
                    ...
                    color: (resultItem.effectiveHover || resultItem.selected) ? Theme.cOnHover : Theme.cOnSurfaceVariant
                    Layout.fillWidth: true
                    elide: Text.ElideRight
                    maximumLineCount: 1
                  }
            ...
            CrawlListView {
              ...
              delegate: Rectangle {
                ...
                radius: Style.iRadiusS
                color: selected ? Theme.cPrimary : (tabItem.hovering ? Theme.cHover : "transparent")
                readonly property bool selected: index === root.currentTabIndex
                property bool hovering: false
                property color tabTextColor: selected ? Theme.cOnPrimary : (tabItem.hovering ? Theme.cOnHover : Theme.cOnSurface)
          ...
          Rectangle {
            ...
            Repeater {
              ...
              delegate: Loader {
                ...
                sourceComponent: CrawlScrollView {
                  id: scrollView
                  anchors.fill: parent
                  horizontalPolicy: ScrollBar.AlwaysOff
                  verticalPolicy: ScrollBar.AsNeeded
            ...
            Rectangle {
              ...
              visible: opacity > 0
              opacity: 0
              color: Qt.alpha(Theme.cSecondary, 0.2)
              border.color: Qt.alpha(Theme.cSecondary, 0.6)
