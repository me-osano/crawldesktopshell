...
ColumnLayout {
  ...
  CrawlHeader {
    label: "Mail Widget"
    description: "Configure the mail bar widget appearance and behavior."
  }
  ...
  CrawlToggle {
    ...
    description: "Display the unread count badge on the mail icon."
  ...
  CrawlToggle {
    ...
    description: "Hide the widget entirely when there are no unread messages."
