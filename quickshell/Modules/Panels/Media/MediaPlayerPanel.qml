      ...
      CrawlBox {
        ...
        RowLayout {
          ...
          Rectangle {
            ...
            color: playerSelectorMouse.containsMouse ? Theme.cPrimary : "transparent"
            ...
            RowLayout {
              ...
              CrawlText {
                ...
                color: playerSelectorMouse.containsMouse ? Theme.cOnPrimary : Theme.cOnSurfaceVariant
              }
              CrawlIcon {
                icon: "chevron-down"
                pointSize: Style.fontSizeXS
              ...
              contentItem: ColumnLayout {
                ...
                Repeater {
                  ...
                  delegate: Rectangle {
                    ...
                    Rectangle {
                      anchors.fill: parent
                      color: itemMouse.containsMouse ? Theme.cPrimary : "transparent"
                    ...
                    RowLayout {
                      ...
                      CrawlIcon {
                        ...
                        icon: "check"
                        color: itemMouse.containsMouse ? Theme.cOnPrimary : Theme.cPrimary
                      ...
                      CrawlText {
                        ...
                        pointSize: Style.fontSizeS
                        color: itemMouse.containsMouse ? Theme.cOnPrimary : Theme.cOnSurface
                        Layout.fillWidth: true
              ...
              CrawlScrollText {
                ...
                scrollMode: {
                  if (root.scrollingMode === "always")
                    return CrawlScrollText.ScrollMode.Always;
                  if (root.scrollingMode === "hover")
                    return CrawlScrollText.ScrollMode.Hover;
                  return CrawlScrollText.ScrollMode.Never;
                }
                delegate: CrawlText {
            ...
            RowLayout {
              ...
              Rectangle {
                ...
                MouseArea {
                  ...
                  cursorShape: Qt.PointingHandCursor
                  hoverEnabled: true
                  onEntered: parent.color = Theme.cPrimary
