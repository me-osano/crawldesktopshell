  ...
  panelContent: Rectangle {
    ...
    function scrollToItem(index) {
      ...
      if (item && item.visible) {
        // Use the internal flickable from CrawlScrollView for accurate scrolling
                    ...
                    Rectangle {
                      ...
                      border.color: {
                        ...
                        if (Settings.data.ui.boxBorderEnabled)
                          return Qt.alpha(Theme.cOutline, Style.opacityHeavy);
                        return "transparent";
                      }
                          ...
                          Flow {
                            ...
                            Repeater {
                              ...
                              delegate: CrawlButton {
                                ...
                                backgroundColor: isSelected ? Theme.cSecondary : Theme.cPrimary
                                textColor: isSelected ? Theme.cOnSecondary : Theme.cOnPrimary
