...
/*
* CrawlContextMenu - Popup-based context menu for use inside panels and dialogs
*
...
*
* For bar widgets and top-level window contexts, use CrawlPopupContextMenu instead,
...
Popup {
  ...
  contentItem: CrawlListView {
    ...
    delegate: ItemDelegate {
      ...
      background: Rectangle {
        color: menuItem.hovered && menuItem.enabled ? Theme.cHover : "transparent"
      ...
      contentItem: RowLayout {
        ...
        CrawlIcon {
          ...
          color: menuItem.hovered && menuItem.enabled ? Theme.cOnHover : Theme.cOnSurface
