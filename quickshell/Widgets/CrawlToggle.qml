...
RowLayout {
  ...
  readonly property string indicatorTooltip: defaultValue !== undefined ? "Default: " + typeof defaultValue === "boolean" ? (defaultValue ? "true" : "false") : String(defaultValue) : ""
  ...
  CrawlLabel {
    ...
    icon: root.icon
    iconColor: root.checked ? Theme.cPrimary : Theme.cOnSurface
  ...
  Rectangle {
    ...
    color: root.checked ? Theme.cPrimary : Theme.cSurface
    ...
    Rectangle {
      ...
      radius: Math.min(Style.iRadiusL, height / 2)
      color: root.checked ? Theme.cOnPrimary : Theme.cPrimary
      border.color: root.checked ? Theme.cSurface : Theme.cSurface
