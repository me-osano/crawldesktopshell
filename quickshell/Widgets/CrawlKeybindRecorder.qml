  ...
  function _applyKeybind(keyStr) {
    ...
    for (let i = 0; i < root.currentKeybinds.length; i++) {
      if (i !== root.recordingIndex && String(root.currentKeybinds[i]).toLowerCase() === keyStr.toLowerCase()) {
        hasConflict = true;
        ToastService.showWarning("Keybind conflict", "The key combination is already assigned to " + root.label || "This action" + ".");
      ...
      Repeater {
        ...
        delegate: MouseArea {
          ...
          Rectangle {
            ...
            color: root.hasConflict && slotArea.isRecordingThis ? Theme.cError : (slotArea.isRecordingThis ? Theme.cSecondary : (slotArea.containsMouse ? Qt.alpha(Theme.cSecondary, 0.15) : Theme.cSurface))
            border.color: root.hasConflict && slotArea.isRecordingThis ? Theme.cError : (slotArea.isRecordingThis ? Theme.cPrimary : (slotArea.containsMouse ? Theme.cSecondary : Theme.cOutline))
            ...
            RowLayout {
              ...
              CrawlIcon {
                ...
                color: slotArea.isRecordingThis ? Theme.cOnSecondary : (slotArea.isOccupied ? Theme.cOnSurfaceVariant : Qt.alpha(Theme.cOnSurfaceVariant, 0.4))
                opacity: 0.8
              ...
              CrawlText {
                ...
                color: slotArea.isRecordingThis ? Theme.cOnSecondary : (slotArea.isOccupied ? Theme.cOnSurface : Theme.cOnSurfaceVariant)
              ...
              Item {
                ...
                CrawlIconButton {
                  ...
                  icon: "x"
                  colorBg: "transparent"
                  colorBgHover: Qt.alpha(Theme.cError, 0.1)
                  colorFg: Theme.cOnSurfaceVariant
                  colorFgHover: Theme.cError
                  border.width: 0
