...
Slider {
  ...
  property color fillColor: Theme.cPrimary
  property var cutoutColor: Theme.cSurface
  ...
  readonly property color effectiveFillColor: enabled ? fillColor : Theme.cOutline
  ...
  background: Item {
    ...
    Shape {
      ...
      ShapePath {
        id: bgPath
        strokeColor: Qt.alpha(Theme.cOutline, 0.5)
        strokeWidth: Style.borderS
        fillColor: Qt.alpha(Theme.cSurface, 0.5)
    ...
    Rectangle {
      ...
      color: root.cutoutColor !== undefined ? root.cutoutColor : Theme.cSurface
  ...
  handle: Item {
    ...
    Rectangle {
      ...
      implicitHeight: knobDiameter
      radius: Math.min(Style.iRadiusL, width / 2)
      color: root.pressed ? Theme.cHover : Theme.cSurface
