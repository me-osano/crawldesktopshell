...
ColumnLayout {
  ...
  Control {
    ...
    background: Rectangle {
      ...
      border.color: input.activeFocus ? Theme.cSecondary : Theme.cOutline
      ...
      Item {
        ...
        RowLayout {
          ...
          TextField {
            ...
            placeholderTextColor: Qt.alpha(Theme.cOnSurfaceVariant, 0.6)
            color: enabled ? Theme.cOnSurface : Qt.alpha(Theme.cOnSurface, 0.4)
