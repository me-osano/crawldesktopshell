...
Item {
  ...
  property color clockColor: Theme.cOnPrimary

  property color secondHandColor: {
    var defaultColor = Theme.cError;
    var bestContrast = 1.0; // 1.0 is "no contrast"
    var bestColor = defaultColor;
    var candidates = [Theme.cSecondary, Theme.cTertiary, Theme.cError];
  ...
  component CrawlClockAnalog: Item {
    property var now
    property color backgroundColor: Theme.cPrimary
    property color clockColor: Theme.cOnPrimary
    property color secondHandColor: Theme.cError
    property real scaleRatio: Style.uiScaleRatio
    anchors.fill: parent
  ...
  component CrawlClockDigital: Item {
    property var now
    property color backgroundColor: Theme.cPrimary
    property color clockColor: Theme.cOnPrimary
    property color progressColor: Theme.cError
    property real hoursFontSize: Style.fontSizeXS
    property real minutesFontSize: Style.fontSizeXXS
    property int hoursFontWeight: Style.fontWeightBold
    property int minutesFontWeight: Style.fontWeightBold
  ...
  component CrawlClockBinary: Item {
    property var now
