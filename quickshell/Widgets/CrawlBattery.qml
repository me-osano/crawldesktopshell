...
Item {
  ...
  property color baseColor: Theme.cOnSurface
  property color lowColor: Theme.cError
  property color chargingColor: Theme.cPrimary
  property color textColor: Theme.cSurface
