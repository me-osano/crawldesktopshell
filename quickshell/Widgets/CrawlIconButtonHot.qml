...
Rectangle {
  ...
  // Color properties
  property color colorBg: Theme.smartAlpha(Theme.cSurfaceVariant)
  property color colorFg: Theme.cPrimary
  property color colorBgHover: Theme.cHover
  property color colorFgHover: Theme.cOnHover
  property color colorBorder: Theme.cOutline
  property color colorBorderHover: Theme.cOutline

  // Hot state colors
  property color colorBgHot: Theme.cPrimary
  property color colorFgHot: Theme.cOnPrimary
