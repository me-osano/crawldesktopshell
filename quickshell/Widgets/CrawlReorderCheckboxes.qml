...
Item {
  ...
  property color dragHandleColor: Theme.cOutline
      ...
      delegate: Item {
        ...
        RowLayout {
          ...
          Rectangle {
            ...
            Layout.preferredHeight: root.baseSize
            radius: Style.iRadiusXS
            color: delegateItem.itemEnabled ? root.activeColor : Theme.cSurface
            border.color: delegateItem.required ? root.activeColor : Theme.cOutline
