...
Popup {
  ...
  property int editMode: CrawlColorPickerDialog.EditMode.R
        ...
        RowLayout {
          ...
          ColumnLayout {
            ...
            RowLayout {
              ...
              CrawlRadioButton {
                ...
                font.weight: Style.fontWeightMedium
                checked: true
                onClicked: root.editMode = CrawlColorPickerDialog.EditMode.R
            ...
            RowLayout {
              ...
              CrawlRadioButton {
                ...
                text: "G"
                font.weight: Style.fontWeightMedium
                onClicked: root.editMode = CrawlColorPickerDialog.EditMode.G
                Layout.fillWidth: false
              }
            ...
            RowLayout {
              ...
              CrawlRadioButton {
                ...
                text: "B"
                font.weight: Style.fontWeightMedium
                onClicked: root.editMode = CrawlColorPickerDialog.EditMode.B
                Layout.fillWidth: false
              }
            ...
            RowLayout {
              ...
              CrawlRadioButton {
                ...
                font.weight: Style.fontWeightMedium
                checked: true
                onClicked: root.editMode = CrawlColorPickerDialog.EditMode.H
                Layout.fillWidth: false
              }
            ...
            RowLayout {
              ...
              CrawlRadioButton {
                ...
                text: "S"
                font.weight: Style.fontWeightMedium
                onClicked: root.editMode = CrawlColorPickerDialog.EditMode.S
                Layout.fillWidth: false
              }
            ...
            RowLayout {
              ...
              CrawlRadioButton {
                ...
                text: "V"
                font.weight: Style.fontWeightMedium
                onClicked: root.editMode = CrawlColorPickerDialog.EditMode.V
                Layout.fillWidth: false
              }
          ...
          RowLayout {
            ...
            CrawlColorSlider {
              id: selectedSlider
              Layout.fillHeight: true
              rainbowMode: root.editMode === CrawlColorPickerDialog.EditMode.H
              topColor: {
                if (rainbowMode)
                  return "transparent";
                switch (root.editMode) {
                case CrawlColorPickerDialog.EditMode.R:
                  return "#FF0000";
                case CrawlColorPickerDialog.EditMode.G:
                  return "#00FF00";
                case CrawlColorPickerDialog.EditMode.B:
                  return "#0000FF";
                default:
                  return "#FFFFFF";
                }
              ...
              Binding {
                ...
                value: {
                  ...
                  case CrawlColorPickerDialog.EditMode.H:
                    return root.displayHue;
                  case CrawlColorPickerDialog.EditMode.S:
                    return root.selectedColor.hsvSaturation;
                  case CrawlColorPickerDialog.EditMode.V:
          ...
          GridLayout {
            ...
            Repeater {
              ...
              Rectangle {
                ...
                border.color: root.selectedColor.toString() === modelData.color.toString() ? Theme.cPrimary : Theme.cOutline
