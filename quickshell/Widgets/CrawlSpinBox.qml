...
RowLayout {
  ...
  Rectangle {
    ...
    border.color: (root.hovering || decreaseArea.containsMouse || increaseArea.containsMouse) ? Theme.cHover : Theme.cOutline
    ...
    Item {
      ...
      CrawlIcon {
        ...
        color: decreaseArea.containsMouse ? Theme.cOnHover : Theme.cPrimary
      }
    ...
    Item {
      ...
      CrawlIcon {
        ...
        icon: "chevron-right"
        pointSize: Style.fontSizeS
        color: increaseArea.containsMouse ? Theme.cOnHover : Theme.cPrimary
      }
    ...
    Item {
      ...
      RowLayout {
        ...
        CrawlText {
          ...
          color: Qt.alpha(Theme.cOnSurface, root.enabled ? 1.0 : 0.6)
