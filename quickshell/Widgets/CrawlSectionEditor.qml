  ...
  function openWidgetSettings(index, widgetData) {
    ...
    function instantiateAndOpen() {
      ...
      if (dialog) {
        ...
        Logger.e("CrawlSectionEditor", "Failed to create settings dialog instance");
      }
    }
    ...
    if (component.status === Component.Ready) {
      ...
      Logger.e("CrawlSectionEditor", component.errorString());
    } else {
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      CrawlText {
        ...
        pointSize: Style.fontSizeS
        color: root.isAtMaxCapacity ? Theme.cError : Theme.cOnSurfaceVariant
        Layout.alignment: Qt.AlignVCenter
      ...
      CrawlIconButton {
        icon: "add"
        colorBg: Theme.cPrimary
        colorFg: Theme.cOnPrimary
        colorBgHover: Theme.cSecondary
        colorFgHover: Theme.cOnSecondary
    ...
    Item {
      ...
      Rectangle {
        ...
        color: Qt.alpha(Theme.cSecondary, 0.12)
        border.color: Theme.cSecondary
            ...
            RowLayout {
              ...
              RowLayout {
                ...
                Loader {
                  ...
                  sourceComponent: CrawlIconButton {
                    icon: "settings"
                    tooltipText: "Widget settings"
                    baseSize: miniButtonSize
                    colorBorder: Qt.alpha(Theme.cOutline, Style.opacityLight)
                    colorBg: Theme.cOnSurface
                    colorFg: Theme.cOnPrimary
                    colorBgHover: Qt.alpha(Theme.cOnPrimary, Style.opacityLight)
                    colorFgHover: Theme.cOnPrimary
                    onClicked: {
